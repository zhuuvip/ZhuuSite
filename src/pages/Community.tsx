          ...
          <div className="flex justify-center mb-7">
            <div style={{ position: "relative", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <div style={{
                ...
                boxShadow: "0 0 30px rgba(255,80,0,0.2), 0 0 60px rgba(255,30,50,0.1)",
              ...
              <div style={{
                ...
                background: "radial-gradient(circle, rgba(255,100,30,0.22) 0%, rgba(255,30,80,0.1) 50%, transparent 70%)",
                filter: "blur(8px)",
              }} />
              {/* Avatar */}
              <div style={{
                ...
                boxShadow: "0 0 28px rgba(255,100,30,0.55), 0 0 56px rgba(255,50,0,0.25)",
              ...
              <div style={{
                ...
                background: "linear-gradient(135deg, rgba(255,107,53,0.95), rgba(200,40,20,0.9))",
